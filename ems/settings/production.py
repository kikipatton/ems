...
ALLOWED_HOSTS = ['ems.neesites.co.ke', '102.217.6.39', 'localhost', 'ems.quantumconnect.africa']
CSRF_TRUSTED_ORIGINS = ['https://ems.neesites.co.ke', 'https://ems.quantumconnect.africa']
